...
export class Backend implements backendInterface {
    ...
    async createIdea(arg0: string, arg1: string, arg2: string): Promise<Idea> {
        if (this.processError) {
            try {
                const result = await this.actor.createIdea(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async deleteIdea(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllIdeas(): Promise<Array<Idea>> {
        if (this.processError) {
            try {
    ...
    async toggleFavorite(arg0: bigint): Promise<Idea> {
        if (this.processError) {
            try {
